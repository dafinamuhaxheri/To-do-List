...
{ private Task[] base;   // the collection of records
  ...
  /** Constructor  Database  initializes the database
   ...
   public TODOLIST(int initial_size)
   { 
      if ( initial_size > 0 )
      { base = new Task[initial_size]; }
      else { base = new Task[1]; }
   }
   ...
   { boolean success = false;
      ...
      { // find an empty element in  base  for insertion of  r:
         ...
         { base[i] = r; }
            ...
            Task[] temp = new Task[base.length * 2];
